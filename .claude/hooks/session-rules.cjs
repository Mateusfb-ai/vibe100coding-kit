...
const regrasFixas = [
  ...
  '2. SKILL A CADA COMANDO: se há 1% de chance de uma skill ajudar, use (feature → brainstorming + spec · bug → systematic-debugging · UI → skill de design · texto para humano → humanizer · entrega pronta → checar-entrega · subir para a main → sync-main).',
